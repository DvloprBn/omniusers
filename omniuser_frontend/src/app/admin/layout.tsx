...
/**
 * Gate real del panel de administración — SOLO `admin`/`super`, verificado
 * en el SERVIDOR (nunca confiar en ocultar un link del lado del cliente
 * como si fuera seguridad real). La autorización REAL de cada acción sigue
 * viviendo en el backend (`RolesGuard`) — esto es solo la capa de UX que
 * evita mostrar un panel roto a quien no debería verlo.
 */
